...
const Header = () => {
  ...
  //WILKIE remove sticky bounce from header
  ...
  // }`}
  return (
    <header className="fixed left-0 top-0 w-full z-99999 py-7 bg-white dark:bg-black shadow !py-4 transition duration-100">
      <div className="px-4 md:px-8 2xl:px-2 lg:flex items-center justify-between relative">
        ...
        <div className="flex">
          ...
          >
            <nav>
              <ul className="flex lg:items-center flex-col lg:flex-row gap-5 lg:gap-10 pl-6">
